...
function NavbarExportTab(props: Props) {
    ...
    return (
        <div>
            ...
            <button className="btn btn-outline btn-success w-full" onClick={() => downloadFile({filename: fileName, spriteSheetFrames: props.exportSettings.spriteSheetFrames, viewport: props.exportSettings.viewport})}> Download </button>
        </div>
    );
}
