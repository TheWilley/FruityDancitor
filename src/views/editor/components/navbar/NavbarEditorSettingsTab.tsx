            ...
            <div className="join">
                ...
                <div className="w-full tooltip tooltip-bottom" data-tip="Sequences - The number of Sequences">
                    <input type="number" className="input input-bordered join-item input-sm w-full"
                           placeholder="Sequences" min={1} value={props.editorSettings.numberOfSequences.value}
                           onChange={(e) => props.editorSettings.numberOfSequences.setValue(Number(e.target.value))}/>
                </div>
            </div>
            <div className="join">
                ...
                <div className="w-full tooltip tooltip-bottom" data-tip="Width - The width of every cell">
                    <input type="number" className="input input-bordered join-item input-sm w-full" placeholder="Width"
                           min={50} value={props.editorSettings.width.value}
            ...
            <div className="join">
                ...
                <div className="w-full tooltip tooltip-bottom" data-tip="Height - The height of every cell">
                    <input type="number" className="input input-bordered join-item input-sm w-full" placeholder="Height"
                           min={50} value={props.editorSettings.height.value}
